<template>
  <div class="statistics-page">
    ...
    <div class="page-header">
      <div>
        <h1 class="page-title">{{ $t('dashboard.projectStatus') }}</h1>
        <p class="page-subtitle">{{ $t('dashboard.totalProjects') }}</p>
      </div>
      <button 
        @click="refreshData" 
        class="refresh-btn"
    ...
    <div v-else class="statistics-content">
      ...
      <div class="metrics-group">
        <div class="metric-card highlight">
          <span class="metric-label">{{ $t('dashboard.totalProjects') }}</span>
          <span class="metric-value">{{ projectStats.total }}</span>
        </div>
        <div class="metric-card">
          <span class="metric-label">{{ $t('dashboard.active') }}</span>
          <span class="metric-value success">{{ projectStats.active }}</span>
        </div>
        <div class="metric-card">
          <span class="metric-label">{{ $t('dashboard.inactive') }}</span>
          <span class="metric-value danger">{{ projectStats.inactive }}</span>
        </div>
      </div>

      <!-- Chart Section -->
      <div class="chart-section">
        <h2 class="section-title">{{ $t('dashboard.projectStatus') }}</h2>
        <DoughnutChart
